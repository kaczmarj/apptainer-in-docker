...
The Dockerfile in this repository installs Apptainer based on the version available in [Alpine](https://pkgs.alpinelinux.org/package/edge/community/x86_64/apptainer).
